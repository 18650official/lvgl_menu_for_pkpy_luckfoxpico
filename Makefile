...
# --- CRITICAL FIX 1: Use $(HOME) instead of '~' for a robust path ---
...
# --- CRITICAL FIX 2: Added -lpthread for threading support required by drivers ---
LDFLAGS        ?= -lm -lpthread
BIN            = demo
BUILD_DIR      = ./build
...
# --- All indented lines below MUST start with a TAB, not spaces ---
